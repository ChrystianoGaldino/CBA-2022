...
subplot(4,1,4); 
 plot(col1, (col9.*sin(acos(col7))),'r',col1a,(col9a.*sin(acos(col7a))),'k',col1b,(col9b.*sin(acos(col7b))),'b','LineWidth',2)
 %title ('Gráfico de Descarga','FontSize', 28);
 xlabel ('tempo (s)','FontSize', L1);
 ylabel ('Q (VA)','FontSize', L1);
...
%  %title ('Gráfico de Descarga','FontSize', 28);
%  xlabel ('tempo (s)','FontSize', L1);
%  ylabel ('Potência Reativa (VA)','FontSize', L1);

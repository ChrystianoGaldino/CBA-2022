...
% %%%%%%%%% Teste 2 - CB com P constante e variação de Q(capacitivo) %%%%%%%%%

Array=csvread('teste2.csv'); %leitura do arquivo
...
ax.FontSize = L3;
 ...
 subplot(4,1,3); 
 plot(col1, sqrt(3)*col9,'b','LineWidth',2)
 %title ('Gráfico de Descarga - CB com variação de Q','FontSize', L1);
 xlabel ('tempo (s)','FontSize', L1);
...
grid on;
 ...
 subplot(4,1,4); 
 plot(col1,(sqrt(3)*col9.*sin(acos(col7))) ,'g','LineWidth',2)
 %title ('Gráfico de Descarga - CB com variação de Q','FontSize', L1);
 xlabel ('tempo (s)','FontSize', L1);
